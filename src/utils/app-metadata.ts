export default class AppMetadata {
  ...
  constructor(isLocalTest: boolean) {
    ...
    this.META_URL = "https://github.com/whosramoss/nextjs-dev-tasks/";
    this.META_NAME = "NextJs Dev Tasks";
  ...
  get defaultMetadata() {
    return {
      ...
      generator: "next.js",
      category: "coding",
      keywords: ["code", "tasks", "management"],
      alternates: {
    ...
    return [
      {
        rel: "shortcut icon",
        type: "image/x-icon",
        url: `${this.META_BASE}favicon.ico`,
      },
      {
        rel: "icon",
        type: "image/x-icon",
      ...
      },
      {
        rel: "icon",
        type: "image/png",
        url: `${this.META_BASE}favicon-32x32.png`,
        sizes: "32x32",
      },
      {
        rel: "icon",
        type: "image/png",
        url: `${this.META_BASE}favicon-16x16.png`,
        sizes: "16x16",
      },
      {
        rel: "icon",
        type: "image/png",
        url: `${this.META_BASE}android-chrome-192x192.png`,
        sizes: "192x192",
      },
      {
        rel: "icon",
        type: "image/png",
        url: `${this.META_BASE}android-chrome-512x512.png`,
        sizes: "512x512",
      },
      {
        rel: "apple-touch-icon",
        url: `${this.META_BASE}apple-touch-icon.png`,
        sizes: "180x180",
      },
    ];
  }
